...
from .TextEncoder import CLIPTextEncoder
def build_model(name: str, state_dict: dict, design_details = None):
    ...
    # text_encoder = CLIPTextEncoder(context_length,vocab_size,transformer_width,transformer_heads,transformer_layers,
    #                                embed_dim)
    # text_encoder.init_weights(state_dict)
    ...
    return model.eval()# ,text_encoder.eval()
